...
const UpdaterConsts = artifacts.require("UnitTestUpdaterConsts");
  ...
  describe("Basic functions", () => {
    ...
    describe("Ownable", () => {
      ...
      it("Should not be able to transfer ownership if not owner", async () => {
        await expect(
          this.sfc.transferOwnership(secondValidator, { from: secondValidator })
  ...
  async ([
    ...
    describe("Methods tests", async () => {
      ...
      it("checking createValidator function", async () => {
        ...
        const secondValidatorID = await this.sfc.getValidatorID(
          secondValidator
        );
        ...
        const firstValidatorObj = await this.sfc.getValidator.call(
          firstValidatorID
        );
        const secondValidatorObj = await this.sfc.getValidator.call(
          secondValidatorID
        );
