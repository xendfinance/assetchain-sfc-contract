...
module.exports = {
    networks: {
        dev: {
            network_id: '42422',
            provider() {
                // > personal.unlockAccount(personal.listAccounts[0], "password", 1000000000);
                return new Web3.providers.IpcProvider('/Users/posidoni/gb/Xend/xend-opera/scripts/datadir/datadir_opera1/opera.ipc', net);
            },
